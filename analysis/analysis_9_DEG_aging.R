...
CCI_results[
  ...
  on = c(
    ...
    "Emitter Cell Type==cell_type", "LIGAND_1==gene"
  ),
...
CCI_results[
  ...
  on = c(
    "Dataset==dataset", "Tissue==tissue",
    "Emitter Cell Type==cell_type", "LIGAND_2==gene"
  ),
...
CCI_results[
  ...
  on = c(
    "Dataset==dataset", "Tissue==tissue",
    "Receiver Cell Type==cell_type", "RECEPTOR_1==gene"
  ),
...
CCI_results[
  ...
  on = c(
    "Dataset==dataset", "Tissue==tissue",
    "Receiver Cell Type==cell_type", "RECEPTOR_2==gene"
  ),
...
CCI_results[
  ...
  on = c(
    "Dataset==dataset", "Tissue==tissue",
    "Receiver Cell Type==cell_type", "RECEPTOR_3==gene"
  ),
...
CCI_results[
  ...
  scDiffCom_regulation := ifelse(
   !`Age Regulation` %in% c("UP", "DOWN"),
   "NO",
   `Age Regulation`
  )
]

deg_comp <- CCI_results[, .N, by = c(
