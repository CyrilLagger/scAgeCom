...
ORA_KEYWORD_COUNTS[
  ,
  `TMS Droplet (male)`:= paste0(`TMS Droplet (male)`, "/6"),
]
ORA_KEYWORD_COUNTS[
  ,
  `TMS Droplet (female)` :=  paste0(`TMS Droplet (female)`, "/9"),
]
ORA_KEYWORD_COUNTS[
  ,
  Calico2019 := paste0(Calico2019, "/3"),
]
